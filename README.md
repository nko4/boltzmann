...
~~~sh
# getting the code
git clone git@github.com:nko4/boltzmann.git && cd ./boltzmann/

# developing
npm install
npm start

# deploying (to http://boltzmann.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@boltzmann.2013.nodeknockout.com
ssh root@boltzmann.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@boltzmann.2013.nodeknockout.com
ssh -i ./id_deploy root@boltzmann.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/boltzmann" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
